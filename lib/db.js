...
/**
 * Vercel's Neon integration injects DATABASE_URL already pointing at the
 * pooled (PgBouncer) endpoint, which is what serverless wants. POSTGRES_URL is
 * accepted as a fallback because some other integrations set that name.
 */
